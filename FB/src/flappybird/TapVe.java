...
//        g.fillRect(0, 0, getWidth(), getHeight()); //ve len ManHinh (JFrame)
            ...
            bg = ImageIO.read(new File("F:\\KyThuatLapTrinhHuongDoiTuong\\Baitap\\FlappyBird\\res\\BG.png"));
...
//            g.fillRect(0, 410, getWidth(), getHeight());
            nendat = ImageIO.read(new File("F:\\KyThuatLapTrinhHuongDoiTuong\\Baitap\\FlappyBird\\res\\NenDat.png"));
            ...
            if (bl == true) {
                gameover = ImageIO.read(new File("F:\\KyThuatLapTrinhHuongDoiTuong\\Baitap\\FlappyBird\\res\\GameOver.png"));
